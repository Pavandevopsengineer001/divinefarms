...
export const metadata: Metadata = {
  ...
  keywords:
    "THE DIVINE FARMS, SRLN Infra Developers, farm plots, Kolanupaka, Aler, Yadadri, weekend getaway, nature living, Telangana real estate, farm cottage, glam pod, clubhouse",
  ...
  openGraph: {
    ...
    description:
      "A New Lifestyle Close to Nature - Premium Farm Plots Near Kolanupaka, Aler with World-Class Amenities",
    type: "website",
  },
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        className={`${poppins.variable} ${playfair.variable} ${geistMono.variable} font-sans antialiased`}
      >
        {children}
        <Analytics />
      </body>
